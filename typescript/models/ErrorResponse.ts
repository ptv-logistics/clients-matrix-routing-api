...
export interface ErrorResponse {
     ...
     * * `MATRIX_ROUTING_DECOMPRESSION_ERROR` - The body cannot be decompressed.
     * * `MATRIX_ROUTING_COMPRESSION_NOT_SUPPORTED` - The usage of compression is not supported for this endpoint.
     * * `ROUTE_ID_ERROR` - The route id retrieval failed. Details can be found in **causes**.
     * 
     ...
     * * `MATRIX_ROUTING_CONTENT_TOO_LARGE` - The body of the request is larger than allowed. Details can be found in **causes**.
     * 
