...
namespace PTV.Developer.Clients.matrixrouting.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api.myptv.com/matrixrouting/v1";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://api.myptv.com/matrixrouting/v1"},
        ...
        public Configuration(
            ...
            string basePath = "https://api.myptv.com/matrixrouting/v1") : this()
        {
        ...
        {
            string report = "C# SDK (PTV.Developer.Clients.matrixrouting) Debug Report:\n";
