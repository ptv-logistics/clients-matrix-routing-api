...
namespace PTV.Developer.Clients.matrixrouting.Model
{
    ...
    public partial class Location : IValidatableObject
    {
        ...
        /// <param name="includeLastMeters">Include the air-line connection between given and matched coordinates in the relation distance and travel time. Will be ignored when **roadAccess** is specified. We will refer to this type of location as an _off-road location_. (default to true).</param>
        ...
        public Location(double? latitude = default(double?), double? longitude = default(double?), RoadAccess roadAccess = default(RoadAccess), bool? includeLastMeters = true, bool? matchSideOfStreet = false)
        {
