...
import com.ptvgroup.developer.client.matrixrouting.model.ListOfLocations;
...
import com.ptvgroup.developer.client.matrixrouting.model.RouteIdentifier;
...
public class MatricesApi {
   ...
   * @param listOfLocations  (required)
   * @param profile A profile defines a vehicle by a set of attributes, matching typical transport situations. It must be the name of one of the [predefined profiles](./concepts/profiles-and-countries) such as EUR_TRAILER_TRUCK. (optional, default to EUR_TRAILER_TRUCK)
   * @return RouteIdentifier
   * @throws ApiException if fails to make API call
   */
  public RouteIdentifier getRouteId(ListOfLocations listOfLocations, String profile) throws ApiException {
    ApiResponse<RouteIdentifier> localVarResponse = getRouteIdWithHttpInfo(listOfLocations, profile);
    return localVarResponse.getData();
  }
   ...
   * @param listOfLocations  (required)
   * @param profile A profile defines a vehicle by a set of attributes, matching typical transport situations. It must be the name of one of the [predefined profiles](./concepts/profiles-and-countries) such as EUR_TRAILER_TRUCK. (optional, default to EUR_TRAILER_TRUCK)
   * @return ApiResponse&lt;RouteIdentifier&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<RouteIdentifier> getRouteIdWithHttpInfo(ListOfLocations listOfLocations, String profile) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getRouteIdRequestBuilder(listOfLocations, profile);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("getRouteId", localVarResponse);
        }
        return new ApiResponse<RouteIdentifier>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<RouteIdentifier>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder getRouteIdRequestBuilder(ListOfLocations listOfLocations, String profile) throws ApiException {
    // verify the required parameter 'listOfLocations' is set
    if (listOfLocations == null) {
      throw new ApiException(400, "Missing the required parameter 'listOfLocations' when calling getRouteId");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/matrices/route";
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(listOfLocations);
      localVarRequestBuilder.method("POST", HttpRequest.BodyPublishers.ofByteArray(localVarPostBody));
    } catch (IOException e) {
      throw new ApiException(e);
    }
